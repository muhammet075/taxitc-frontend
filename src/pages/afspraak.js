...
export default function Afspraak() {
    ...
    return (
        <div className="container">
            ...
            <p id="afspraakcontent1">Wilt u een afspraak inplannen? Dat kan, neem contact met ons op door ons te bellen via 06 12 34 56 78. U kunt ons ook een berichtje sturen via WhatsApp of u kunt ons ook mailen. Hieronder ziet u een overzicht van de mogelijkheden om een afspraak te maken.</p>
            <ul>
